    ...
    return(
        <div className="w-1/4 flex flex-col">
            ...
            <div className="flex justify-center mb-1">
                <a target={"_blank"} href={`https://etherscan.io/token/${nft.contract.address}`} className="py-2 px-4 bg-blue-500 w-3/5 text-center rounded-m text-white cursor-pointer">View on Etherscan</a>
            </div>
        </div>
    )
}